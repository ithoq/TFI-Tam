@ModelType IEnumerable(Of EE.Papel)
...
<div class="panel panel-transparent">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <div class="col-xs-12">
                @Code
                    If User.IsInRole("CrearPapel") Then
                    @<div class="btn-group">
        ...
        <table class="table table-hover" id="tablaPapeles">
            ...
            <tbody>
                @For Each item In Model
                    ...
                    @<tr>
                        <td>
                            @Html.DisplayFor(Function(modelItem) currentItem.Espesor)
                        </td>
                        <td>
                        ...
                        <td class="center">
                            @Code
                            If User.IsInRole("ConsultarPapel") Then
