@section breadcrumb
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#" class="active">Política de privacidad</a>
        </li>
    </ul>
end section
<div class="panel panel-default bg-success">
    ...
    <div class="panel-body">
        <p class="text-white">
            Esta política se basa en nuestro objetivo fundamental de ofrecer a nuestros visitantes información y recursos de calidad y al mismo tiempo mantener el anonimato individual y la privacidad personal. La siguiente declaración describe la política de privacidad de ASAHI.
        ...
        <p>
            <h4>Recopilación de datos de los visitadores de ASAHI</h4>
        </p>
        <p class="text-white">
            Cuando usted accede a nuestras páginas web, la información sobre el usuario y la información técnica esencial y accidental es recopilada de manera automática, nos referimos a esas categorías recogidas de manera colectiva como  información de “acceso”. Ninguna otra información es recogida a través del sitio ASAHI, excepto cuando usted deliberadamente decide revelarla (por ejemplo, pulsando una tecla para enviarnos un mensaje de correo electrónico). La información que usted puede decidir enviarnos está enumerada más adelante como “información opcional”.
            <ul class="text-white">
                Información recopilada automáticamente
                <li>Información del visitante: el dominio de Internet y la dirección en Internet del computador que usted está utilizando.</li>
                <li>Información técnica esencial: identificación de la página o servicio que usted está solicitando, tipo de navegador y sistema operativo que utiliza; y la fecha y hora del acceso.</li>
                <li>Información técnica no esencial: la dirección Internet del sitio web que le remitió a nosotros, y  la “información cookie” descrita más adelante.</li>
                Información opcional
                <li>Cuando usted nos envía un correo electrónico: su nombre, dirección de correo electrónico y el contenido del mensaje.</li>
                <li>Cuando usted llena formularios electrónicos: todos los datos que usted elige dar o confirmar.</li>
            </ul>
        </p>
        <p class="text-white">
                ...
                Uso de cookies
                El sitio web de la ASAHI utiliza “cookies” un pequeño archivo de datos trasferido de un sitio web al disco duro de su computador, para recopilar de manera anónima información sobre el tráfico de datos. Enviamos cookies cuando usted navega en ASAHI, responde a encuestas o cuestionarios en línea, o solicita información. Aceptar cookies utilizados por nuestro sitio no nos permite acceder a su Información de Identificación Personal, pero podemos utilizar cookies para identificar su computador. La información colectiva recogida nos permite analizar modelos de tráfico en nuestro sitio. Esto nos ayuda a ofrecerle un mejor servicio al mejorar el contenido y hacer más fácil el uso de nuestro sitio.
        </p>
        <p>
            <h4>Nuestro compromiso para la protección de los datos</h4>
        </p>
        <p class="text-white">
            ASAHI no vende ninguna información de identificación personal ofrecida voluntariamente en el sitio a terceras partes. Para prevenir el acceso no autorizado, mantener la exactitud de los datos, y garantizar el uso correcto de a información, hemos instaurado procedimientos físicos, electrónicos y administrativos para salvaguardar y proteger la información que recogemos en línea, de acuerdo con las políticas de ASAHI.
            Todos los empleados que tienen acceso al tratamiento o intervienen en el procesamiento de datos personales, están obligados a respetar la confidencialidad de los asuntos oficiales, incluyendo los datos personales.
        </p>
        <p>
            <h4>Cómo contactarnos</h4>
        </p>
        <p class="text-white">
            Si tiene otras preguntas o preocupaciones sobre nuestras políticas y prácticas de
            privacidad, por favor envíe un correo electrónico a  infoasahi@gmail.com.
        </p>
</div>
</div>
