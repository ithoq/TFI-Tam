@ModelType IEnumerable(Of EE.Cartucho)
...
<div class="panel panel-transparent">
    ...
    <div class="panel-body">
        <table class="table table-hover" id="tablaCartuchos">
            <thead>
                <tr>
                    <th>Modelo</th>
                    <th>Marca</th>
            ...
            <tbody>
                @For Each item In Model
                    ...
                    @<tr>
                        <td>
                            @Html.DisplayFor(Function(modelItem) currentItem.Modelo)
                        </td>
                        <td>
                            @Html.DisplayFor(Function(modelItem) currentItem.Marca)
                        </td>
                        <td>
                        ...
                        <td class="center">
                            @Code
                            If User.IsInRole("ConsultarCartucho") Then
