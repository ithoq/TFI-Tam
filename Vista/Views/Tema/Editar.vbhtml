...
@section breadcrumb
    <ul class="breadcrumb">
        <li>
            <a href="@Url.Action("Index", "Tema")">Temas</a>
        </li>
        <li>
            ...
            <div class="panel-body">
                @Using Html.BeginForm()
                    ...
                    @<fieldset>
                        ...
                        <div class="form-group form-group-default required @(If(Html.ViewData.ModelState.IsValidField(Convert.ToString(Html.IdFor(Function(model) model.Tema))), Nothing, "has-error")) ">
                            @Html.LabelFor(Function(model) model.Tema)
                            @Html.TextBoxFor(Function(model) model.Tema, New With {.class = "form-control"})
