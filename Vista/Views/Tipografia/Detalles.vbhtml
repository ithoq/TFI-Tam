@ModelType EE.Tipografia

@Section breadcrumb
    <ul class="breadcrumb">
        <li>
            <a href="@Url.Action("Index", "Tipografia")">Tipografias</a>
        </li>
        <li>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @Using Html.BeginForm("Eliminar", "Tipografia", New With {.id = Model.Id}, FormMethod.Get)
